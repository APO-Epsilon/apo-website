	...
	if(!$resultO){
		...
		while($r = mysqli_fetch_array($resultO)){
			...
			*/
			...
			echo "<div class=\"row\"><div class=\"small-4 columns\">$DOW<br>$theDate</div><div class=\"small-2 columns\">$start</div><div class=\"small-2 columns\">$end</div><div class=\"small-2 columns text-center\">$length $v $ma</div><div class=\"small-2 columns text-center\">$max</div></div>";
