	...
	if(!$resultO){
		...
		while($r = mysqli_fetch_array($resultO)){
			...
			*/
			...
			echo "<div class=\"row\"><div class=\"small-4 columns\"><div class=\"row\"><div class=\"small-12 columns\">$DOW</div></div><div class=\"row\"><div class=\"small-12 columns\">$theDate</div></div></div><div class=\"small-2 columns\">$start</div><div class=\"small-2 columns\">$end</div><div class=\"small-2 columns\">$length $v $ma</div><div class=\"small-2 columns\">$max</div></div>";
